...
public class CartActivity extends AppCompatActivity implements RecyclerViewAdapter.OnItemClickListener, CartActivityView,CartAdapter.ClickChangeCount {
    ...
    private void initData(){
        ...
        tvCostCart.setText(Utils.formatNumberMoney(ManageCart.getCart().totalCart())+" đ");
    }
